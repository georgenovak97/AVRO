...
class FamilyBrowserTreeUiTests(unittest.TestCase):
    def test_tree_template_has_folder_icons_and_connectors(self):
        ...
        self.assertNotIn("StrokeDashArray", template_text)
        self.assertNotIn("BranchLine", template_text)
        self.assertNotIn("BranchArm", template_text)
        self.assertNotIn("BranchLastLine", template_text)
